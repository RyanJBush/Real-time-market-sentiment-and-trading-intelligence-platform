...
export const MOCK_AGGREGATES: Record<string, TickerAggregation> = {
  AAPL: {
    ...
    avg_score: 0.78,
    avg_confidence: 0.71,
    weighted_sentiment_score: 0.56,
    weighted_confidence: 0.69,
    positive_ratio: 0.69,
    neutral_ratio: 0.22,
    negative_ratio: 0.09,
    source_breakdown: { financial_news: 14, social_curated: 9 },
  ...
  MSFT: {
    ...
    avg_score: 0.67,
    avg_confidence: 0.65,
    weighted_sentiment_score: 0.34,
    weighted_confidence: 0.63,
    positive_ratio: 0.54,
    neutral_ratio: 0.31,
    negative_ratio: 0.15,
    source_breakdown: { financial_news: 10, earnings_wire: 7 },
    window_start: new Date(Date.now() - 1000 * 60 * 60 * 24).toISOString(),
    window_end: new Date().toISOString(),
  },
  TSLA: {
    ...
    avg_score: 0.43,
    avg_confidence: 0.58,
    weighted_sentiment_score: -0.14,
    weighted_confidence: 0.55,
    positive_ratio: 0.18,
    neutral_ratio: 0.34,
    negative_ratio: 0.48,
    source_breakdown: { financial_news: 16, social_curated: 12 },
    window_start: new Date(Date.now() - 1000 * 60 * 60 * 24).toISOString(),
    window_end: new Date().toISOString(),
  },
  NVDA: {
    ...
    avg_score: 0.81,
    avg_confidence: 0.78,
    weighted_sentiment_score: 0.62,
    weighted_confidence: 0.76,
    positive_ratio: 0.74,
    neutral_ratio: 0.18,
    negative_ratio: 0.08,
    source_breakdown: { earnings_wire: 12, financial_news: 9 },
    window_start: new Date(Date.now() - 1000 * 60 * 60 * 24).toISOString(),
    window_end: new Date().toISOString(),
  },
  AMZN: {
    ...
    avg_score: 0.61,
    avg_confidence: 0.62,
    weighted_sentiment_score: 0.22,
    weighted_confidence: 0.60,
    positive_ratio: 0.49,
    neutral_ratio: 0.29,
    negative_ratio: 0.22,
    source_breakdown: { financial_news: 10, social_curated: 6 },
    window_start: new Date(Date.now() - 1000 * 60 * 60 * 24).toISOString(),
    window_end: new Date().toISOString(),
  },
};
